...
const MOCK_INVENTORY = [
  ...
  notes: "Former government fleet utility truck with service body and roof ladder rack. Fleet-maintained, clean title, passed California Smog and strong 6.0L V8 engine.",
},
  {
    id: "2",
    year: 2016,
